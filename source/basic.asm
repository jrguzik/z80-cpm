...
; MACROS
        ...
        .MACRO  RESV F, E       ; Define Reserverd word
        .BYTE   \F + 80H
        .ASCII  "\E"
        .ENDM
...
COPY:   LD      A,(DE)          ; Get source
        ...
        LD      (BUFFER+104+1),A ; Mark end of buffer
...
SIGNON: .ASCII  "Z80 BASIC Ver 4.7b"
        ...
        .ASCII  "C"
        .BYTE   41
        CRLFZ   " 1978 by Microsoft"
        .BYTE    0

MEMMSG: .ASCIZ  "Memory top"
...
PUTCTL: LD      A,B             ; Get number of bytes in buffer
        CP      104+1            ; Test for line overflow
